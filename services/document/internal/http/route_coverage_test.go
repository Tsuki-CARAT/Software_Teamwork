...
func TestActiveReportRoutesHaveStableScaffoldCoverage(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodGet, "/reports/rpt_123/jobs", "not_implemented"},
		{http.MethodPost, "/reports/rpt_123/jobs", "not_implemented"},
		{http.MethodGet, "/report-jobs/job_123", "not_implemented"},
		{http.MethodGet, "/report-jobs/job_123/attempts", "not_implemented"},
		{http.MethodPost, "/report-jobs/job_123/attempts", "not_implemented"},
		{http.MethodGet, "/reports/rpt_123/events", "not_implemented"},
